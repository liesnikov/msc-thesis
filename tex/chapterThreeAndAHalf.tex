...
\end{coq}
\caption{\coqe{i_assumption} definition in Ltac2}
...
Finally, if neither of the searches -- by \coqe{find} or \coqe{i_assumption_coq} -- yields any results we throw an Iris exception (\coqe{Iriception}) with a message on what couldn't be found in the context.
