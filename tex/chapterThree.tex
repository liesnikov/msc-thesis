...
\begin{figure}[H]
\begin{coq}
refine (tac_assumption _ j false P);
  ...
  |pm_reduce; (* evaluate env_delete and if-branch *)
   iSolveTC]
\end{coq}
\caption{Part of Ltac1 implementation of iExact}
...
This is almost exactly the implementation of \coqe{iExact}, but \coqe{iAssumption} itself is a bit more complicated and we will go through it in the next chapter.
