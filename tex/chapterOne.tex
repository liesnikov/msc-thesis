...
A very useful tacticals of Ltac is \coqe{match goal}.
...
I.e.\ it is used in \coqe{naive_solver} from stdpp~\cite{std++developersandcontributorsStdpp}, one of the first examples in CPDT~\cite{chlipalaCertifiedProgrammingDependent2013} and \coqe{break_match} tactic from StuctTact library~\cite{uwplse-structtactdevelopmentteamStructTact2020}.
