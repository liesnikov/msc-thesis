...
A notable thing with this tactic is not just readability, assuming one is familiar with \lstinline|match goal| construct.
...
the composite tactic \lstinline|do 2 iAssumption'| would still work.
