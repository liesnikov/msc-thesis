...
Lemma tac_wp_allocN Δ Δ' s E j K v n Φ :
  ...
  (∀ l, ∃ Δ'',
    envs_app false (Esnoc Enil (true, j) (array l 1 (replicate (Z.to_nat n) v))) Δ' = Some Δ'' ∧
...
Lemma tac_twp_allocN Δ s E j K v n Φ :
  0 < n →
  (∀ l, ∃ Δ',
    envs_app false (Esnoc Enil (true,j) (array l 1 (replicate (Z.to_nat n) v))) Δ
    = Some Δ' ∧
    envs_entails Δ' (WP fill K (Val $ LitV $ LitLoc l) @ s; E [{ Φ }])) →
  envs_entails Δ (WP fill K (AllocN (Val $ LitV $ LitInt n) (Val v)) @ s; E [{ Φ }]).
Proof.
...
Lemma tac_wp_alloc Δ Δ' s E j K v Φ :
  MaybeIntoLaterNEnvs 1 Δ Δ' →
  (∀ l, ∃ Δ'',
    envs_app false (Esnoc Enil (true, j) (l ↦ v)) Δ' = Some Δ'' ∧
...
Lemma tac_wp_load Δ Δ' s E i K l q v Φ :
  MaybeIntoLaterNEnvs 1 Δ Δ' →
  envs_lookup_true i Δ' = Some (false, l ↦{q} v)%I →
...
Lemma tac_wp_store Δ Δ' Δ'' s E i K l v v' Φ :
  MaybeIntoLaterNEnvs 1 Δ Δ' →
  envs_lookup_true i Δ' = Some (false, l ↦ v)%I →
  envs_simple_replace i false (Esnoc Enil (true,i) (l ↦ v')) Δ' = Some Δ'' →
...
Lemma tac_wp_cmpxchg Δ Δ' Δ'' s E i K l v v1 v2 Φ :
  MaybeIntoLaterNEnvs 1 Δ Δ' →
  envs_lookup_true i Δ' = Some (false, l ↦ v)%I →
  envs_simple_replace i false (Esnoc Enil (true,i) (l ↦ v2)) Δ' = Some Δ'' →
...
Lemma tac_wp_faa Δ Δ' Δ'' s E i K l z1 z2 Φ :
  MaybeIntoLaterNEnvs 1 Δ Δ' →
  envs_lookup_true i Δ' = Some (false, l ↦ LitV z1)%I →
  envs_simple_replace i false (Esnoc Enil (true,i) (l ↦ LitV (z1 + z2))) Δ' = Some Δ'' →
